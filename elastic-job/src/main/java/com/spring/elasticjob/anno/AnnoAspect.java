...
public class AnnoAspect {
     ...
     * 针对注解建立切点
     */
    @Pointcut(value = "@annotation(com.spring.elasticjob.anno.UseCases)")
    ...
    @Pointcut(value = "execution(* com.spring.elasticjob.anno.PasswordUtils.*(..))")
